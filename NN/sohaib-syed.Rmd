---
title: "Nueral Network with keras/Tensorflow"
output: 
  html_notebook:
    toc: yes
    toc_float: yes
...
# Scale the dataset.    We will scale our dataset so all of the
...
### Part 2.1-C-ii
```{r}
#  As the batch size increased the stats got worse. The accuracy, balanced accuracy, and per class statistics decreased as size increased. This makes sense because the model has many smaller sets of data to train and less likely to generalize to the entire dataset.
```
### Part 2.-D
```{r}
...
```
---There is definitely a performance increase. It was difficult choosing a correct construction because 3 out of the 4 I made had a better overall accuracy than the model in a. However I chose the model that used 16 neurons with the softmax activation function because along with a higher overall accuracy, the average balanced accuracy of the classes was higher.
